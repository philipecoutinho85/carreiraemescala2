...
function HeroForm() {
  ...
  return (
    <form className="w-full max-w-md bg-white/[0.02] p-6 lg:p-8 rounded-2xl border border-white/10 backdrop-blur-xl shadow-2xl relative" onSubmit={handleSubmit}>
      <div className="absolute -top-3 right-6 bg-purple-600 text-white text-[10px] font-bold uppercase tracking-wider py-1 px-3 rounded-full shadow-[0_0_10px_rgba(147,51,234,0.5)]">
        Vagas Limitadas
      </div>
      ...
      <div className="space-y-4 mb-8">
        <div className="relative">
          ...
          <input
            ...
            required
            className="glass-input w-full rounded-lg py-3.5 pl-12 pr-4 text-white placeholder-gray-500 transition-all outline-none"
          />
        </div>
        <div className="relative">
        ...
        <div className="pt-2">
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="relative w-full">
              ...
              <label htmlFor="sim" className="radio-label block text-center bg-dark-900 text-gray-400 text-sm font-medium py-2.5 rounded-lg hover:bg-white/5">Sim, possuo</label>
            </div>
            <div className="relative w-full">
              ...
              <label htmlFor="nao" className="radio-label block text-center bg-dark-900 text-gray-400 text-sm font-medium py-2.5 rounded-lg hover:bg-white/5">Ainda não</label>
            </div>
          </div>
        </div>
      </div>

      <button type="submit" className="group w-full bg-gradient-to-r from-purple-700 to-purple-500 text-white font-bold py-4 rounded-lg hover:from-purple-600 hover:to-purple-400 transition-all shadow-[0_0_20px_rgba(168,85,247,0.3)] hover:shadow-[0_0_30px_rgba(168,85,247,0.5)] uppercase tracking-wider text-sm flex items-center justify-center gap-2">
        Garantir Minha Vaga
...
function HeroSection() {
  return (
    <section className="relative pt-10 pb-20 lg:pt-16 lg:pb-32 overflow-hidden bg-dark-950 z-10 border-b border-white/5">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10 mt-4">
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-12">
          <div className="w-full lg:w-1/2 flex flex-col items-start text-left" data-aos="fade-right">
            <div className="inline-flex items-center gap-2.5 bg-white/5 border border-white/10 px-4 py-2 rounded-full mb-6 backdrop-blur-md shadow-lg">
            ...
            <h1 className="font-heading text-4xl md:text-5xl lg:text-7xl font-black leading-[1.1] tracking-tight mb-6">
              CARREIRA <br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-purple-600">EM ESCALA</span>
            </h1>

            <p className="text-base lg:text-lg text-gray-300 font-light mb-8 max-w-lg leading-relaxed">
            ...
            <div className="flex flex-wrap items-center gap-5 text-sm text-gray-300 mb-10 font-medium bg-dark-900/50 p-4 rounded-xl border border-white/5 backdrop-blur-sm w-full max-w-md">
              <div className="flex items-center gap-2.5"><i className="ph-fill ph-calendar-blank text-purple-400 text-xl"></i><span>15 DE MAIO</span></div>
              <div className="w-px h-6 bg-white/10"></div>
              <div className="flex items-center gap-2.5"><i className="ph-fill ph-clock text-purple-400 text-xl"></i><span>20H</span></div>
              <div className="w-px h-6 bg-white/10"></div>
              <div className="flex items-center gap-2.5"><i className="ph-fill ph-desktop text-purple-400 text-xl"></i><span>AO VIVO</span></div>
            </div>

            <HeroForm />
          </div>

          <div className="w-full lg:w-1/2 flex justify-center items-end relative min-h-[450px] lg:min-h-[650px] mt-12 lg:mt-0" data-aos="fade-left" data-aos-delay="100">
            <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[80%] h-[80%] bg-purple-600/15 blur-[100px] rounded-full z-0 pointer-events-none"></div>
            <div className="relative z-10 w-full max-w-[500px] mx-auto flex justify-center">
              <img
...
function ProfileSection() {
  return (
    <section className="py-24 relative bg-dark-900 z-10 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="text-center mb-16" data-aos="fade-up">
          ...
          <p className="text-gray-400 mt-5 max-w-2xl mx-auto text-lg">O mercado financeiro de alto nível separa curiosos de profissionais. Identifique de qual lado você está operando hoje.</p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 relative">
          ...
          <div className="space-y-6">
            <div className="flex items-center gap-4 mb-8 border-b border-red-500/20 pb-4" data-aos="fade-right">
              <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-red-500/20 to-red-500/5 flex items-center justify-center border border-red-500/30 shadow-[0_0_15px_rgba(239,68,68,0.15)]">
                <i className="ph-bold ph-trend-down text-red-500 text-2xl"></i>
              </div>
            ...
            <div className="flex flex-col gap-4">
              {notForItems.map((item, index) => (
                <div key={item} className="bg-dark-950/80 border border-white/5 rounded-xl p-5 hover:border-red-500/30 transition-all duration-300 transform hover:-translate-x-2 backdrop-blur-md group" data-aos="fade-right" data-aos-delay={100 * (index + 1)}>
                  <div className="flex items-start gap-4">
                    <div className="mt-0.5 shrink-0 w-6 h-6 rounded-full bg-dark-800 group-hover:bg-red-500/20 flex items-center justify-center transition-colors">
                      <i className="ph-bold ph-x text-gray-500 group-hover:text-red-500 text-xs transition-colors"></i>
                    </div>
          ...
          <div className="space-y-6 mt-8 lg:mt-0">
            <div className="flex items-center gap-4 mb-8 border-b border-green-500/20 pb-4" data-aos="fade-left">
              <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-green-500/20 to-green-500/5 flex items-center justify-center border border-green-500/30 shadow-[0_0_15px_rgba(34,197,94,0.15)]">
                <i className="ph-bold ph-trend-up text-green-500 text-2xl"></i>
              </div>
            ...
            <div className="flex flex-col gap-4">
              {idealForItems.map((item, index) => (
                <div key={item} className="bg-white/[0.03] border border-green-500/20 rounded-xl p-5 shadow-[0_0_20px_rgba(34,197,94,0.02)] hover:border-green-500/50 hover:bg-green-500/10 transition-all duration-300 transform hover:translate-x-2 backdrop-blur-md group" data-aos="fade-left" data-aos-delay={100 * (index + 1)}>
                  <div className="flex items-start gap-4">
                    <div className="mt-0.5 shrink-0 w-6 h-6 rounded-full bg-green-500/20 group-hover:bg-green-500/30 flex items-center justify-center transition-colors">
                      <i className="ph-bold ph-check text-green-400 text-xs"></i>
                    </div>
...
function StatsGrid() {
  ...
  return (
    <div id="stats-container" ref={statsRef} className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full" data-aos="fade-up" data-aos-delay="200">
      <div className="rounded-2xl p-6 lg:p-8 flex items-center justify-center lg:justify-start gap-5 bg-gradient-to-r from-dark-900 to-dark-950 border border-white/5 shadow-lg relative overflow-hidden group">
        ...
        <div className="w-16 h-16 flex items-center justify-center bg-white/5 rounded-xl text-purple-400 shrink-0 border border-white/10"><i className="ph-fill ph-chart-bar text-4xl"></i></div>
      ...
      <div className="rounded-2xl p-6 lg:p-8 flex items-center justify-center lg:justify-start gap-5 bg-gradient-to-r from-dark-900 to-dark-950 border border-white/5 shadow-lg relative overflow-hidden group">
        <div className="absolute inset-0 bg-purple-500/5 translate-x-[-100%] group-hover:translate-x-0 transition-transform duration-500 ease-in-out"></div>
        <div className="w-16 h-16 flex items-center justify-center bg-white/5 rounded-xl text-purple-400 shrink-0 border border-white/10"><i className="ph-fill ph-users-three text-4xl"></i></div>
      ...
      <div className="rounded-2xl p-6 lg:p-8 flex items-center justify-center lg:justify-start gap-5 bg-gradient-to-r from-dark-900 to-dark-950 border border-white/5 shadow-lg relative overflow-hidden group">
        <div className="absolute inset-0 bg-purple-500/5 translate-x-[-100%] group-hover:translate-x-0 transition-transform duration-500 ease-in-out"></div>
        <div className="w-16 h-16 flex items-center justify-center bg-white/5 rounded-xl text-purple-400 shrink-0 border border-white/10"><i className="ph-fill ph-user-focus text-4xl"></i></div>
...
function AboutSection() {
  return (
    <section className="py-24 relative bg-dark-950 z-10 border-t border-white/5">
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex flex-col gap-16 lg:gap-20">
          <div className="flex flex-col lg:flex-row gap-12 lg:gap-20 items-center">
            <div className="relative w-[280px] lg:w-[420px] h-[380px] lg:h-[500px] shrink-0 mx-auto lg:mx-0" data-aos="zoom-in">
              <div className="absolute top-16 bottom-0 left-0 right-0 rounded-[2rem] p-[2px] bg-gradient-to-tr from-cyan-400/80 via-purple-500 to-purple-700 shadow-[0_0_40px_rgba(168,85,247,0.3)] z-0">
              ...
              <div className="absolute -right-4 top-24 z-20 bg-dark-900/90 border border-purple-500/30 backdrop-blur-md px-4 py-3 rounded-xl shadow-2xl animate-float">
            ...
            <div className="flex-1 text-center lg:text-left space-y-8" data-aos="fade-up" data-aos-delay="100">
              <div>
              ...
              <div className="text-gray-300 space-y-6 font-light text-base lg:text-lg leading-relaxed border-l-2 border-purple-500/30 pl-5 lg:pl-8 ml-1 lg:ml-0">
                ...
                <blockquote className="bg-white/5 border border-white/10 p-6 rounded-r-2xl rounded-bl-2xl italic text-gray-200 shadow-inner mt-4 relative">
                  <span className="absolute top-2 left-2 text-purple-500/20 font-serif text-6xl leading-none">"</span>
                  <p className="relative z-10 pt-2"><strong className="text-white font-semibold text-purple-400 text-xl">Investir de forma consistente não depende da venda de um produto.</strong> Depende da construção de um método, alinhamento técnico e acompanhamento cirúrgico.</p>
                </blockquote>
              </div>
            </div>
          </div>
...
function WorkshopSection() {
  return (
    <section className="py-24 relative bg-dark-900 z-10 overflow-hidden border-t border-white/5">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
          {workshopItems.map((item, index) => (
            <div key={item.lesson} className="bg-dark-950 border border-white/5 rounded-2xl p-8 hover:-translate-y-2 hover:border-purple-500/30 hover:shadow-[0_15px_30px_rgba(168,85,247,0.1)] transition-all duration-300 group relative overflow-hidden" data-aos="fade-up" data-aos-delay={100 * (index + 1)}>
              ...
              <div className="flex items-center justify-between mb-6">
                <span className="text-white font-bold flex items-center gap-2 bg-white/5 px-3 py-1 rounded-md text-sm"><i className="ph-fill ph-play-circle text-purple-400 text-lg"></i> {item.lesson}</span>
                <div className="w-12 h-12 flex items-center justify-center bg-dark-900 border border-white/5 rounded-xl text-gray-500 group-hover:bg-purple-500/20 group-hover:text-purple-400 group-hover:border-purple-500/30 transition-all duration-300"><i className={`ph-fill ${item.icon} text-2xl`}></i></div>
              </div>
...
function TestimonialsSection() {
  ...
  return (
    <section className="py-24 relative bg-dark-950 overflow-hidden border-t border-white/5 z-10">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="relative w-full max-w-5xl mx-auto flex items-center justify-center min-h-[300px] md:min-h-[350px]" data-aos="fade-up" data-aos-delay="100">
          <button onClick={() => setCurrentIndex((prev) => (prev - 1 + testimonials.length) % testimonials.length)} className="absolute left-0 md:-left-12 z-20 w-12 h-12 flex items-center justify-center bg-white/5 border border-white/10 rounded-full text-gray-400 hover:text-white hover:bg-purple-600 hover:border-purple-500 transition-all shadow-lg" aria-label="Anterior"><i className="ph-bold ph-caret-left text-xl"></i></button>
          <button onClick={() => setCurrentIndex((prev) => (prev + 1) % testimonials.length)} className="absolute right-0 md:-right-12 z-20 w-12 h-12 flex items-center justify-center bg-white/5 border border-white/10 rounded-full text-gray-400 hover:text-white hover:bg-purple-600 hover:border-purple-500 transition-all shadow-lg" aria-label="Próximo"><i className="ph-bold ph-caret-right text-xl"></i></button>

          <div className="relative w-full h-[300px] md:h-[350px] flex items-center justify-center px-12 md:px-0">
            {testimonials.map((item, index) => {
              const isActive = index === currentIndex
              return (
                <div key={item.author} className={`carousel-item absolute w-full md:w-[50%] text-center transition-all duration-500 ease-in-out px-6 ${getItemClass(index)}`}>
                  <i className="ph-fill ph-quotes text-4xl text-purple-500/30 mb-4 inline-block"></i>
                  <p className="desc text-base md:text-lg leading-relaxed mb-8 transition-colors duration-500">{item.text}</p>
        ...
        <div className="flex justify-center items-center gap-2.5 mt-2" data-aos="fade-up" data-aos-delay="200">
          {testimonials.map((_, index) => (
            <button
              ...
              className={index === currentIndex ? 'w-8 h-2.5 rounded-full bg-purple-500 transition-all duration-300 shadow-[0_0_10px_rgba(168,85,247,0.8)]' : 'w-2.5 h-2.5 rounded-full bg-white/20 transition-all duration-300 hover:bg-white/40'}
...
function FooterSection() {
  ...
  return (
    <footer className="py-16 relative bg-dark-950 z-10 border-t border-white/10">
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex flex-col lg:flex-row items-center justify-between gap-10 bg-white/[0.02] border border-white/5 rounded-3xl p-8 lg:p-12 backdrop-blur-md shadow-2xl">
          ...
          <div className="flex flex-col items-center lg:items-end w-full lg:w-auto" data-aos="fade-left" data-aos-delay="100">
